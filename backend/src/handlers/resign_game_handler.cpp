#include "resign_game_handler.hpp"
...
ResignGameHandler::ResignGameHandler(
...
std::string ResignGameHandler::HandleRequestThrow(
    ...
    try {
        ...
        const auto game = service.ResignGame(game_id, owner_id);
